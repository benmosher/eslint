 ...
 * @param {string} parserName The parser setting passed from the config file.
 * @param {object?} parser The corresponding parser module object, or `null` if it could not be required.
 */
function RuleContext(ruleId, eslint, severity, options, settings, parserOptions, parserName, parser) {
    // public.
    this.id = ruleId;
